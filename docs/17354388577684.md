...
#define PIXHG_Module_Register(moduleName, className, id) __attribute__((used, section("__DATA,__HGLaunchDATA"))) \
static const struct PIXHG_String __S##id= (struct PIXHG_String){moduleName, className};
```
...
使用方法
```
PIXHG_Module_Register("PIXABAuxiliary", "PushModuleDelegate", 2)
PIXHG_Module_Register("PIXABAuxiliary", "HomeModuleDelegate", 3)
PIXHG_Module_Register("PIXABAuxiliary", "DataAnalyzeModuleDelegate", 4)
PIXHG_Module_Register("PIXABAuxiliary", "AuxiliaryModuleDelegate", 5)
PIXHG_Module_Register("PIXABAuxiliary", "AppActionModuleDelegate", 6)
```
